...
async function getMoneyPipelineData() {
  const svc = pm2.getService('money-pipeline');
  try {
    await axios.get(`${config.MONEY_PIPELINE}/`, { timeout: 5000 });
    return {
      up: true,
...
module.exports = { getMoneyPipelineData };
