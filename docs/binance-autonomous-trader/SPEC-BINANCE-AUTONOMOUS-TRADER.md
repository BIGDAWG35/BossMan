...
### Dual-layer $75 floor (L-CRYPTO-14 contract)
...
### What's NOT in Phase 2-3 (separate, future cards)

- Bot reads `bossman_decision.json` for trade gating (Stage 7, separate approval).
