...
**Total: 39 files / ~304 KB.** (Plus 4 split `OPERATINGBLUEPRINT_*` files at `~/.hermes/` root — rows 28g–28j — total ~108 KB. Plus 4 split `AGENTS_*` files at `~/.hermes/` root — rows 28k–28n — total ~36 KB.)
